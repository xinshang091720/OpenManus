...
class BrowserContextHelper:
    ...
    async def get_browser_state(self) -> Optional[dict]:
        # Do not import BrowserUse until a browser-enabled agent actually
        # asks for browser state. This keeps non-browser desktop Runs light.
...
class BrowserAgent(ToolCallAgent):
    ...
    @staticmethod
    def _browser_tools() -> ToolCollection:
        browser_tool_type = import_module("app.tool.browser_use_tool").BrowserUseTool
        return ToolCollection(browser_tool_type(), Terminate())

    available_tools: ToolCollection = Field(default_factory=_browser_tools)
